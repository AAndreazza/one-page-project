    ...
    return(
        ...
        <header className='absolute inset-x-0 top-0 z-50'>
            ...
            <div className='hidden lg:flex lg:gap-x-12'>
                <Link to='#' className='text-sm font-semibold leading-6 text-white'>Empresa</Link>
                <Link to='#' className='text-sm font-semibold leading-6 text-white'>Institucional</Link>
                <Link to='#' className='text-sm font-semibold leading-6 text-white'>Depoimentos</Link>
            </div>
            <div className='hidden lg:flex lg:flex-1 lg:justify-end'>
                <Link to='#' className='text-sm font-semibold leading-6 text-white'>Whatsapp <span aria-hidden='true'>&rarr;</span></Link>
            </div>
            </nav>
        </header>
        ...
        <div className='relative isolate overflow-hidden pt-14'>
            ...
            <div className='text-center'>
                ...
                <Link to='#' className='text-sm font-semibold leading-6 text-white'>Saiba mais <span aria-hidden='true'>→</span></Link>
                </div>
            </div>
            </div>
